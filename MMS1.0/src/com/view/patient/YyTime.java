 ...
 * 科室预约时间
 */
public class YyTime extends MouseAdapter {
    ...
    public YyTime(TextField dateText) {
            ...
            for (int i = 1; i < 7; i++) {
                for (int j = 0; j < 7; j++) {
                    ...
                    if (buttons[i][j].equals(e.getSource())) {
                        curX = i;
                        curY = j;
                        buttons[curX][curY].setBackground(new Color(255, 155,
                                234));
                    }
                }
            }
    ...
    public void setDate() {
        ...
        buttons[curX][curY].setBackground(new Color(255, 155, 234));
